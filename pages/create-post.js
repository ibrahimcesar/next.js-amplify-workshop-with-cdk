...
function CreatePost() {
  ...
  return (
    <div>
      ...
      <p>🙇‍♂️ Please, please, please: Be kind, post catto, doggos, squirrels and weasels and other great things, but let's keep SFE (Safe For Everyone). Let's have a nice thing here!</p>
      <input
        onChange={onChange}
        name="title"
        placeholder="Title"
